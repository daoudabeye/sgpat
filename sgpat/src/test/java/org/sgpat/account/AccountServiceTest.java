...
public class AccountServiceTest {
	...
	public void shouldThrowExceptionWhenUserNotFound() {
		...
		when(accountRepositoryMock.findOneByUsername("user@example.com")).thenReturn(null);
		// act
	...
	public void shouldReturnUserDetails() {
		...
		when(accountRepositoryMock.findOneByUsername("user@example.com")).thenReturn(demoUser);
